...
const FilterComponent = () => {
  ...
  const handleFilter = async () => {
    ...
    setTitleError(""); // Reset error messages
    setLocationError("");
    ...
    const filterData = {
      ...
      type: selectedType || null, // Include the selected type
    };
      ...
      >
        ...
        >
          <Button
            ...
            variant={selectedType === "Movie" ? "contained" : "outlined"}
            color="error"
          ...
          <Button
            ...
            variant={selectedType === "Concert" ? "contained" : "outlined"}
            color="error"
        ...
        >
          ...
          <TextField
            ...
            InputProps={{
              startAdornment: (
                <LocationCityIcon sx={{ marginRight: "8px", color: "white" }} />
              ),
            }}
            error={!!locationError}
